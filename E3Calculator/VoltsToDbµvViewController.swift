//
//  VoltsToDbµvViewController.swift
//  E3Calculator
//
...
class VoltsToDbµvViewController: UIViewController, UITextFieldDelegate {
    ...
    func calculateConversion() {
        ...
        // Coversion Logic
        let firstCalculation = log10(subtotal)
        let total = firstCalculation * 20 + 120
        print(total)
        let roundedTotal = Double(total).roundToPlaces(places: 8)
        
        return outputLabel.text = "= \(roundedTotal) dBµV"
    }
