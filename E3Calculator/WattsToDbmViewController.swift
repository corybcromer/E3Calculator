//
//  WattsToDbmViewController.swift
//  E3Calculator
//
...
class WattsToDbmViewController: UIViewController, UITextFieldDelegate {
    ...
    func calculateConversion() {
        ...
        let total = firstCalculation * 10 + 30
        print(total)
        let roundedTotal = Double(total).roundToPlaces(places: 8)
        
        return outputLabel.text = "= \(roundedTotal) dBm"
    }
