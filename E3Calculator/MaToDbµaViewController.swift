...
class MaToDbµaViewController: UIViewController, UITextFieldDelegate {
    ...
    func calculateConversion() {
        ...
        let total = firstCalculation * 20 + 60
        print(total)
        let roundedTotal = Double(total).roundToPlaces(places: 8)
        
        return outputLabel.text = "= \(roundedTotal) dBµA"
    }
