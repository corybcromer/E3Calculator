//
//  WattsToDbwViewController.swift
//  E3Calculator
//
...
class WattsToDbwViewController: UIViewController, UITextFieldDelegate {
    ...
    func calculateConversion() {
        ...
        let total = firstCalculation * 10 
        print(total)
        let roundedTotal = Double(total).roundToPlaces(places: 8)
        
        return outputLabel.text = "= \(roundedTotal) dBW"
    }
