//
//  VoltsToDbvViewController.swift
//  E3Calculator
//
...
class VoltsToDbvViewController: UIViewController, UITextFieldDelegate {
    ...
    func calculateConversion() {
        ...
        let total = firstCalculation * 20 
        print(total)
        let roundedTotal = Double(total).roundToPlaces(places: 8)
        
        return outputLabel.text = "= \(roundedTotal) dBV"
    }
